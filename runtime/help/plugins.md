...
* `micro`
    ...
    [BufPane](https://pkg.go.dev/github.com/schollz/micro/v2/internal/action#BufPane)
    [InfoPane](https://pkg.go.dev/github.com/schollz/micro/v2/internal/action#InfoPane)
    [Tab](https://pkg.go.dev/github.com/schollz/micro/v2/internal/action#Tab)
    [TabList](https://pkg.go.dev/github.com/schollz/micro/v2/internal/action#TabList)
...
* `micro/config`
    ...
    Relevant links:
    [Buffer](https://pkg.go.dev/github.com/schollz/micro/v2/internal/buffer#Buffer)
    [buffer.Completer](https://pkg.go.dev/github.com/schollz/micro/v2/internal/buffer#Completer)
...
* `micro/buffer`
    ...
    Relevant links:
    [Message](https://pkg.go.dev/github.com/schollz/micro/v2/internal/buffer#Message)
    [Loc](https://pkg.go.dev/github.com/schollz/micro/v2/internal/buffer#Loc)
    [display.SLoc](https://pkg.go.dev/github.com/schollz/micro/v2/internal/display#SLoc)
    [Buffer](https://pkg.go.dev/github.com/schollz/micro/v2/internal/buffer#Buffer)
    [Error](https://pkg.go.dev/builtin#error)
...
https://pkg.go.dev/github.com/schollz/micro/v2/internal to see the full list
